...
namespace LidyaPos\Media\Http\Controllers;

use LidyaPos\Media\Http\Resources\FileResource;
use LidyaPos\Media\Http\Resources\FolderResource;
...
use LidyaPos\Media\Services\UploadsManager;
use LidyaPos\Media\Supports\Zipper;
use Eloquent;
use Exception;
use File;
