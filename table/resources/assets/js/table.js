(($, DataTable) => {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: dt => {
            return '<i class="far fa-file-excel"></i> ' + dt.i18n('buttons.excel', LidyaPosVariables.languages.tables.excel ? LidyaPosVariables.languages.tables.excel : 'Excel');
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: dt => {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.export', LidyaPosVariables.languages.tables.export ? LidyaPosVariables.languages.tables.export : 'Export') + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: dt => {
            return '<i class="fas fa-file-csv"></i> ' + dt.i18n('buttons.csv', LidyaPosVariables.languages.tables.csv ? LidyaPosVariables.languages.tables.csv : 'CSV');
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: dt => {
            return '<i class="fa fa-print"></i> ' + dt.i18n('buttons.print', LidyaPosVariables.languages.tables.print ? LidyaPosVariables.languages.tables.print : 'Print');
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: dt => {
            return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', LidyaPosVariables.languages.tables.reset ? LidyaPosVariables.languages.tables.reset : 'Reset');
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: dt => {
            return '<i class="fas fa-sync"></i> ' + dt.i18n('buttons.reload', LidyaPosVariables.languages.tables.reload ? LidyaPosVariables.languages.tables.reload : 'Reload');
        },
    ...
    class TableManagement {
        ...
        handleActionsRow() {
            ...
            $(document).on('click', '.delete-many-entry-trigger', event => {
                ...
                if (ids.length === 0) {
                    LidyaPos.showError(LidyaPosVariables.languages.tables.please_select_record ? LidyaPosVariables.languages.tables.please_select_record : 'Please select at least one record to perform this action!');
                    return false;
                }
        ...
        loadBulkChangeData($element) {
            ...
            $.ajax({
                ...
                success: res => {
                    ...
                    LidyaPos.initResources();
                },
                error: error => {
                    LidyaPos.handleError(error);
                }
            });
        }
