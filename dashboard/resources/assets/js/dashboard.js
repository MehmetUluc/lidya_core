            ...
            success: res =>  {
                ...
                if (!res.error) {
                    ...
                    if (el.find('.scroller').length !== 0) {
                        LidyaPos.callScroll(el.find('.scroller'));
                    }
            ...
            Sortable.create(el, {
                ...
                onEnd: () => {
                    ...
                    $.ajax({
                        ...
                        success: res =>  {
                            if (!res.error) {
                                LidyaPos.showSuccess(res.message);
                            } else {
                                LidyaPos.showError(res.message);
                            }
                        },
                        error: data =>  {
    ...
    init() {
        ...
        list_widgets.on('change', '.number_record .numb', event =>  {
            ...
            if (!isNaN(paginate)) {
                ...
                LidyaPos.showError('Please input a number!')
            }
