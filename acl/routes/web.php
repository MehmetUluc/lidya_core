...
use LidyaPos\ACL\Http\Controllers\Auth\ForgotPasswordController;
use LidyaPos\ACL\Http\Controllers\Auth\LoginController;
use LidyaPos\ACL\Http\Controllers\Auth\ResetPasswordController;
use LidyaPos\ACL\Http\Controllers\UserController;

Route::group(['namespace' => 'LidyaPos\ACL\Http\Controllers', 'middleware' => ['web', 'core']], function () {
