...
namespace LidyaPos\ACL\Http\Controllers;

use Assets;
use LidyaPos\Base\Events\UpdatedContentEvent;
use LidyaPos\Media\Services\ThumbnailService;
use File;
use Illuminate\Contracts\View\Factory;
use Illuminate\Http\RedirectResponse;
use Illuminate\Support\Facades\Auth;
use LidyaPos\ACL\Forms\PasswordForm;
use LidyaPos\ACL\Forms\ProfileForm;
use LidyaPos\ACL\Forms\UserForm;
use LidyaPos\ACL\Tables\UserTable;
use LidyaPos\ACL\Http\Requests\CreateUserRequest;
use LidyaPos\ACL\Http\Requests\UpdatePasswordRequest;
use LidyaPos\ACL\Http\Requests\UpdateProfileRequest;
use LidyaPos\ACL\Models\UserMeta;
use LidyaPos\ACL\Repositories\Interfaces\RoleInterface;
use LidyaPos\ACL\Repositories\Interfaces\UserInterface;
use LidyaPos\ACL\Services\ChangePasswordService;
use LidyaPos\ACL\Services\CreateUserService;
use LidyaPos\Base\Events\CreatedContentEvent;
use LidyaPos\Base\Events\DeletedContentEvent;
use LidyaPos\Base\Forms\FormBuilder;
use LidyaPos\Base\Http\Controllers\BaseController;
use LidyaPos\Base\Http\Responses\BaseHttpResponse;
use LidyaPos\Media\Repositories\Interfaces\MediaFileInterface;
use LidyaPos\ACL\Http\Requests\AvatarRequest;
use Exception;
