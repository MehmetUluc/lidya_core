...
namespace LidyaPos\ACL\Models;

use LidyaPos\ACL\Notifications\ResetPasswordNotification;
use LidyaPos\ACL\Traits\PermissionTrait;
use LidyaPos\Base\Supports\Avatar;
