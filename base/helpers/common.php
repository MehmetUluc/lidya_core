...
use LidyaPos\Base\Facades\DashboardMenuFacade;
use LidyaPos\Base\Facades\PageTitleFacade;
use LidyaPos\Base\Supports\Editor;
...
if (!function_exists('dashboard_menu')) {
    /**
     * @return \LidyaPos\Base\Supports\DashboardMenu
     */
